function Get_ReData(Item , req)
{
    ...
    var title = ["學期" ,"系所名稱" ,"年級","課程代碼(14碼)","課程名稱","授課老師","上課人數/限制人數","學分數","課別","地點","星期","節次","備註","教學計劃"];
    var item_title = ["Sem" ,"Faculty_Name" ,  "Grad" , "Course_Id" ,"Course_Name" , "Teacher" , "Course_People,Limit_People" , "Credits" , "Course_Type" , "Course_Place" , "Course_Day" , "Course_Time" , "Course_Other" ,"Class_Plan" ]; 
    ...
    for (var i = 0; i < Item.length ; i++)
    {
        ...
        for (var x= 0 ; x < title.length ; x++)
        {
            ...
            {
                temp[title[x]] = Item[i].Course_People + "/" +Item[i].Limit_People;
            }
            else
            {
